module OdptCommon::Modules::MethodMissing::Decision::Common::Operator
  ...
  def method_missing( method_name , *args )
    if args.empty?
      regexp_not = ::OdptCommon::Modules::MethodMissing::Decision::Common::Operator::REGEXP_NOT
      regexp_operated_by = ::OdptCommon::Modules::MethodMissing::Decision::Common::Operator::REGEXP_OPERATED_BY
