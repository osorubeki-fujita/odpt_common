...
describe String , "coverted by \"OdptCommon::StringExt\"" do
  ...
  it "is converted by method \'process_train_operation_text\'" do
    ...
    str_after_5 = "17時26分頃、築地駅で人身事故のため、折返し運転を行っています。\n全線での運転再開は、18時30分頃を見込んでいます。\n折返し運転区間：北千住 - 八丁堀駅間／霞ケ関 - 中目黒駅間\nただいま、東京メトロ線、都営地下鉄線、JR線、東急線、東武線、京成線、つくばエクスプレスで振替輸送を実施しています。\n詳しくは、駅係員にお尋ねください。"
